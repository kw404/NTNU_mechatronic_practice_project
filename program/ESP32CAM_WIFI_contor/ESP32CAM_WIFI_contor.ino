...
//i2c command ESP傳給ARDUINO的訊號編碼
#define CAR_FORWARD_LEFT      'q'
#define CAR_FORWARD           'w'
#define CAR_FROWARD_RIGHT     'e'
#define CAR_RIGHT             'd'
#define CAR_STOP              'k'
#define CAR_LEFT              'a'
#define CAR_BACKWARD_LEFT     'z'
...
<html>
    ...
    <body class="noselect" 
        ...
        <table  id="mainTable" 
            ...
            <tr><!-- 第一行按紐 -->
                <td class="button" 
                    ontouchstart='sendButtonInput("MoveCar","7")'   /*車子向前*/
...
void handleNotFound(AsyncWebServerRequest *request){ request->send(404, "text/plain", "File Not Found");}
